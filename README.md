...
------------------------------------------------------------------------------------------------------------------------------------
## The main branch of this repository is automatically built and deployed using AWS services:

1. AWS CodePipeline detects changes pushed to the main branch.

2. It triggers AWS CodeBuild to run the build process, compiling the project and preparing assets.
